...
class DFOperator(DFNotTerminal):
    attr_names = ('operator',)
    def __init__(self, nextnodes, operator,lineno=0):
...
class DFConcat(DFNotTerminal):
    attr_names = ()
    def __init__(self, nextnodes, lineno=0):
        self.nextnodes = nextnodes
        self.lineno = lineno
    def __repr__(self):
        return 'Concat'
...
class DFBranch(DFNotTerminal):
    attr_names = ()
    def __init__(self, condnode, truenode, falsenode, lineno=0):
...
class DFEvalValue(DFNode):
    ...
    def __init__(self, value, width=32, isfloat=False, isstring=False, lineno=0):
        self.value = value
        self.width = width
...
class DFUndefined(DFNode):
    attr_names = ('width',)
    def __init__(self, width, lineno=0):
        self.width = width
        self.lineno = lineno
    def __repr__(self):
        ret = ''
...
class DFDelay(DFNotTerminal):
    attr_names = ()
    def __init__(self, nextnode, lineno=0):
...
class DFSyscall(DFNotTerminal):
    attr_names = ()
    def __init__(self, syscall, nextnodes, lineno=0):
...
################################################################################
class Term(object):
    def __init__(self,name,termtype=(),msb=None,lsb=None,lenmsb=None,lenlsb=None, lineno=0):
        #print(f'\n.....  Term ,Term.name type:{type(name)} ,name:{name},Term.termtype:{type(termtype)}, termtype:{termtype},Term.msb type:{type(msb)} ')
...
################################################################################
class Bind(object):
    def __init__(self, tree, dest, msb=None, lsb=None, ptr=None, alwaysinfo=None, parameterinfo='', lineno=0):
        self.tree = tree
        self.dest = dest
        self.msb = msb
        self.lsb = lsb
